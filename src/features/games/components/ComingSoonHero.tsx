...
export default function ComingSoonHero() {
  return (
    <Card className="overflow-hidden bg-gradient-to-r from-[#00B96B] via-[#00B96B] to-[#00B96B] p-6 text-white sm:p-8">
      <div className="flex flex-col gap-8 lg:flex-row lg:items-center">
        ...
        <div className="order-2 flex flex-1 items-center justify-center lg:justify-end">
          <div className="relative h-56 w-56 sm:h-64 sm:w-64">
            <div className="absolute inset-4 rounded-full bg-[#00B96B] shadow-sm" />
            ...
            <div className="absolute left-1/2 top-12 h-2.5 w-2.5 -translate-x-6 rounded-full bg-[#009f5c]" />
            <div className="absolute left-1/2 top-12 h-2.5 w-2.5 translate-x-3 rounded-full bg-[#009f5c]" />
            <div className="absolute -bottom-3 left-6 h-10 w-10 rounded-full bg-[#00B96B]/80" />
            <div className="absolute -bottom-6 left-20 h-12 w-12 rounded-full bg-[#00B96B]/70" />
            <div className="absolute -bottom-4 right-12 h-9 w-9 rounded-full bg-[#00B96B]/70" />

            <div className="absolute -left-6 top-8 rounded-full bg-slate-900 px-3 py-1 text-xs font-semibold text-white shadow-sm">
              ? Streak +900
            </div>
            <div className="absolute -right-4 bottom-10 rounded-full bg-white/90 px-3 py-1 text-xs font-semibold text-slate-900 shadow-sm">
              ?? Rank 2450
            </div>
