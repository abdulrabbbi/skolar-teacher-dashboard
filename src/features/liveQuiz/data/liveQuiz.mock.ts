...
export type PastQuiz = {
  ...
  // ✅ add this (sub heading like Figma)
  subject: string;
...
export const liveQuizStats: LiveQuizStat[] = [
  { id: "quizzes-month", label: "Quizzes This Month", value: "12", icon: "quizzes" },
  { id: "avg-participation", label: "Avg Participation", value: "92%", icon: "participation" },
  { id: "avg-score", label: "Avg Score", value: "75%", icon: "score" },
  { id: "questions-asked", label: "Questions Asked", value: "148", icon: "questions" },
];

export const recentQuizzes: RecentQuiz[] = [
  { id: "recent-probability", title: "Probability Basics", date: "Dec 15, 2025", participants: 22, avg: 78 },
  { id: "recent-integration", title: "Integration Review", date: "Dec 12, 2025", participants: 24, avg: 65 },
  { id: "recent-functions", title: "Functions Quiz", date: "Dec 8, 2025", participants: 20, avg: 82 },
];

export const quickLaunchTemplates: QuickLaunchTemplate[] = [
  { id: "template-differentiation", title: "Differentiation Quiz", questions: 10, minutes: 15, type: "differentiation" },
  { id: "template-integration", title: "Integration Review", questions: 8, minutes: 12, type: "integration" },
  { id: "template-probability", title: "Probability Challenge", questions: 12, minutes: 18, type: "probability" },
];
...
export const questionCountOptions: LiveQuizSelectOption[] = [
  { id: "questions-10", label: "10 questions", value: "10 questions" },
];

export const timerOptions: LiveQuizSelectOption[] = [
  { id: "timer-90", label: "90 seconds", value: "90 seconds" },
];
